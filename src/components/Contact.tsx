      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 max-w-5xl mx-auto">
          ...
          >
                ...
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <div className="relative flex items-center space-x-3 sm:space-x-4 p-4 sm:p-5 bg-gray-900/60 backdrop-blur-md rounded-xl sm:rounded-2xl border border-gray-800/50 hover:border-gray-700/50 transition-all duration-300">
                      ...
                      <div>
                        <h4 className="font-semibold text-white text-base sm:text-lg mb-0.5 sm:mb-1">{info.title}</h4>
                        <p className="text-gray-400 group-hover:text-gray-300 transition-colors duration-200 text-sm sm:text-base">{info.value}</p>
                      </div>
                    </div>
                  </motion.a>
                ))}
            ...
            <div>
              <h4 className="text-xl sm:text-2xl font-semibold text-white mb-4 sm:mb-6">Connect with me</h4>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                {socialLinks.map((link, index) => (
                  ...
                  >
                    ...
                    <div className={`relative flex items-center space-x-2 sm:space-x-3 p-3 sm:p-4 bg-gradient-to-r ${link.color} rounded-lg sm:rounded-xl text-white transition-all duration-200 shadow-md hover:shadow-lg`}>
                      {link.icon}
                      <div>
